...
//				.setFixedWidth(300);
		...
		footerComponent = cmp.text("A = Absent, W = Worked, OH = On Holiday, NI = No Clockin, NO = No Clockout, OL = ON Leave, CS= Check Shift")
				.setStyle(
	 ...
	 */
	public static ComponentBuilder<?, ?> createTitleComponent(CompanyDetails company,String label,String from, String to)throws IOException {
