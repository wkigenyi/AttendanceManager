 ...
 */
@ConvertAsProperties(
        dtd = "-//systems.tech247.attendance//CompDays//EN",
        autostore = false
)
...
@Messages({
    ...
    "HINT_CompDaysTopComponent="
})
public final class CompDaysTopComponent extends TopComponent implements ExplorerManager.Provider {
    ...
    public CompDaysTopComponent(){
        this(null);
    }
    
    public CompDaysTopComponent(final Employees emp) {
        initComponents();
        setName(Bundle.CTL_CompDaysTopComponent()+" ->"+emp.getSurName()+" "+emp.getOtherNames());
        setToolTipText(Bundle.HINT_CompDaysTopComponent());
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if(evt.getSource()==jdcTo && evt.getPropertyName()=="date"){
                    ...
                    if(cTo.getTimeInMillis()<cFrom.getTimeInMillis()){
                        ...
                        em.setRootContext(new AbstractNode(Children.create(new FactoryCompDays(emp, from, to), true)));
                    }
                }
            }
        });
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(CompDaysTopComponent.class, "CompDaysTopComponent.jLabel1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(CompDaysTopComponent.class, "CompDaysTopComponent.jLabel2.text")); // NOI18N
