 ...
 */
@ConvertAsProperties(
        dtd = "-//systems.tech247.attendance//AttEmployeeList//EN",
        autostore = false
)
...
@Messages({
    ...
    "HINT_AttEmployeeListTopComponent=This is a EmployeeList window"
})
public final class AttEmployeeListTopComponent extends TopComponent implements ExplorerManager.Provider{
    ...
    public AttEmployeeListTopComponent() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(AttEmployeeListTopComponent.class, "AttEmployeeListTopComponent.jLabel1.text")); // NOI18N

        jtEmployeeName.setText(org.openide.util.NbBundle.getMessage(AttEmployeeListTopComponent.class, "AttEmployeeListTopComponent.jtEmployeeName.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jcbDisengaged, org.openide.util.NbBundle.getMessage(AttEmployeeListTopComponent.class, "AttEmployeeListTopComponent.jcbDisengaged.text")); // NOI18N
    ...
    void loadItems(QueryEmployee query){
        em.setRootContext(new AbstractNode(Children.create(new FactoryAttEmployeesList(query), true)));
    }
}
