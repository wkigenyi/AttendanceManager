...
import systems.tech247.clockinutil.FactoryAbsentDays;
import systems.tech247.clockinutil.FactoryCompDays;
 ...
 */
@ConvertAsProperties(
        dtd = "-//systems.tech247.attendance//AbsentDays//EN",
        autostore = false
)
...
@Messages({
    ...
    "HINT_AbsentDaysTopComponent="
})
public final class AbsentDaysTopComponent extends TopComponent implements ExplorerManager.Provider {
    ...
    public AbsentDaysTopComponent(){
        this(null);
    }
    
    public AbsentDaysTopComponent(final Employees emp) {
        initComponents();
        setName(Bundle.CTL_AbsentDaysTopComponent()+" ->"+emp.getSurName()+" "+emp.getOtherNames());
        setToolTipText(Bundle.HINT_AbsentDaysTopComponent());
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if(evt.getSource()==jdcTo && evt.getPropertyName()=="date"){
                    ...
                    if(cTo.getTimeInMillis()<cFrom.getTimeInMillis()){
                        ...
                        em.setRootContext(new AbstractNode(Children.create(new FactoryAbsentDays(emp, from, to), true)));
                    }
                }
            }
        });
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(AbsentDaysTopComponent.class, "AbsentDaysTopComponent.jLabel1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(AbsentDaysTopComponent.class, "AbsentDaysTopComponent.jLabel2.text")); // NOI18N
